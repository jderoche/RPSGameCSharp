...
namespace BaseClass.PlayerMgt
{
    ...
    public abstract class Player : IPlayer
    {
        ...
        /// <summary>
        /// Current GameControler win counter
        /// </summary>
        private int currentGameWinCnt;


        /// <summary>
        /// Player move list (can be configure by high level module (GameControler Manager))
        /// </summary>
        ...
        public delegate GameDB.MoveType userMoveLogic();
        public userMoveLogic delagateUserMoveLogic;
